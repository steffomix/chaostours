...
class ModelTaskStatistics {
  ...
  static ModelTaskStatistics fromMap(Map<String, Object?> map) {
    return ModelTaskStatistics(
  ...
  static Future<ModelTaskStatistics> statistics(ModelTask model) async {
    final q = '''
